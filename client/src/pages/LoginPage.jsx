    ...
    return (
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-zinc-950 px-4">
            <div className="w-full max-w-sm bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
                <p className="text-xs text-amber-400 font-medium tracking-widest uppercase mb-1">Welcome back</p>
                <h1 className="text-2xl font-bold text-white mb-7">Sign in</h1>
                ...
                <div className="border-t border-zinc-800 mt-6 pt-5 text-center text-xs text-zinc-500">
                    No account?{" "}
                    <a href="/register" className="text-amber-400 hover:underline font-medium">Register here</a>
                </div>
            </div>
        </div>
    );
